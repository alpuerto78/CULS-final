...
namespace CULS_Client
{
    public partial class form_admin_setting : Form
    {
        ...
        private void btn_network_settings_Click(object sender, EventArgs e)
        {
            IP_Configuration form_ip_config = new IP_Configuration();
            form_ip_config.Show();
            this.Hide();
        ...
        private void btn_credentials_Click(object sender, EventArgs e)
        {
            form_update_credential f1 = new form_update_credential();
            f1.Show();
            this.Hide();
        ...
        private void btn_ext_client_Click(object sender, EventArgs e)
        {
            Environment.Exit(0);
        }
